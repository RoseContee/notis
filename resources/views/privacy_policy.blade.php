...
@section('content')
    ...
    <div class="py-7 flq-background-color-100">
        <div class="container pt-navbar">
            <h1 class="display-3 mb-0">Privacy Policy</h1>
        </div>
    </div>
    <div class="content-wrap">
        <div class="container py-7">
            <h1>Privacy Policy of Notis Studios</h1>
            <p>Notis Studios operates the&nbsp;<span class=\"highlight preview_website_name\">Website Name</span>&nbsp;website, which provides the SERVICE.</p>
