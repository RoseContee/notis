            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        @can('add_permission')
                        <li class="nk-block-tools-opt" data-toggle="modal" data-target="#modalCreate"><a href="{{ route('permission.create') }}" class="btn btn-outline-success"><em class="icon ni ni-plus"></em><span>Add Permission</span></a>
                        </li>
                        @endif
                    </ul>
                </div>
