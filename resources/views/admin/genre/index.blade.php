                        ...
                        <div class="nk-block">
                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">All Genres
                                        @can('add_genre')
                                        <a href="{{route('genre.create')}}" class="btn btn-outline-success float-right"><em class="icon ni ni-plus"></em><span>Add Genre</span></a>
                                        @endcan
                                    </h4>
                                                ...
                                                <td class="nk-tb-col">
                                                    <ul class="nk-tb-actions gx-1">
                                                        ...
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{route('genre.edit', $genre->id)}}" class="btn btn-sm btn-outline-success d-inline-flex"><em class="icon ni ni-expand"></em><span>Edit</span></a>
                                                        </li>
                                                        @endcan
                                                        @can('delete_genre')
                                                            <li class="nk-tb-action-hidden">
