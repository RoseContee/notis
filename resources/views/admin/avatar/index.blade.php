                        ...
                        <div class="nk-block">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">All Avatar
                                        <a href="{{route('avatar.create')}}" class="btn btn-outline-success float-right"><em class="icon ni ni-plus"></em><span>Add Avatar</span></a>
                                ...
                                <div class="card-inner">
                                    <table style="width: 100%;" class="datatable-init-export nk-tb-list nk-tb-ulist" data-export-title="Export" data-auto-responsive="false">
                                        ...
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col"><span class="sub-text">Avatar</span></th>
                                            <th class="nk-tb-col"><span class="sub-text">Is Default?</span></th>
                                        ...
                                        @foreach ($avatars as $avatar)
                                            <tr class="nk-tb-item">
                                                <td class="nk-tb-col">
                                                    <img width="200px" height="200px" src="{{url('/')}}/avatars/{{$avatar->avatar_path}}" alt="">
                                                </td>
                                                <td class="nk-tb-col">
                                                    ...
                                                    <ul class="nk-tb-actions gx-1">
                                                        ...
                                                        @can('delete_avatar')
                                                            <li class="nk-tb-action-hidden">
                                                                <form action="{{ route('avatar.delete',$avatar->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
