                            ...
                            <div class="col-xxl-12">
                                ...
                                <table class="datatable-init nowrap nk-tb-list is-separate dataTable no-footer" data-auto-responsive="false" id="DataTables_Table_2" role="grid" aria-describedby="DataTables_Table_2_info">
                                    ...
                                    <tr class="nk-tb-item nk-tb-head" role="row">
                                        ...
                                        <th class="nk-tb-col  sorting" ><span>Address</span></th>
                                    ...
                                    @foreach ($withdraws as $withdraw)
                                        <tr class="nk-tb-item odd">
                                            ...
                                            <td class="nk-tb-col"><span class="tb-sub"><span class="title">{{$withdraw->user->email}}</span></span></td>
                                            ...
                                            <td class="nk-tb-col">
                                                @if($withdraw->status == '0')
                                                    <a href="{{route('withdraw_approve', $withdraw->id)}}" class="btn btn-success btn-sm edit-shop-btn">Approve</a>
                                                    <a href="{{route('withdraw_reject', $withdraw->id)}}" class="btn btn-danger btn-sm delete-shop-btn" style="color: white">Reject</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
