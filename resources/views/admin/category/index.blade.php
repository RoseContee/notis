                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">All Categories
                                        <a href="{{route('category.create')}}" class="btn btn-outline-success float-right"><em class="icon ni ni-plus"></em><span>Add Category</span></a>
                                    </h4>
                                ...
                                <div class="card-inner">
                                    <table style="width: 100%;" class="datatable-init-export nk-tb-list nk-tb-ulist" data-export-title="Export" data-auto-responsive="false">
                                        ...
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col"><span class="sub-text">Top Category</span></th>
                                            <th class="nk-tb-col"><span class="sub-text">Picture</span></th>
                                        ...
                                        @foreach($categories as $category)
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col">
                                                    <img style="width: 200px; height: 200px" src="{{$category->getFirstMediaUrl('picture')}}" alt="">
                                                </td>
                                                <td class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        @can('edit_category')
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('category.edit',['category'=>$category->id]) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">
