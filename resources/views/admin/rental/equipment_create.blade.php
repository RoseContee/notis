            ...
            <div class="nk-block nk-block-lg">
                <div class="nk-block-between mb-2">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Add Equipment</h3>
                ...
                <div class="card">
                    <div class="card-inner">
                        ...
                        <form method="POST" action="{{ route('equipment.store') }}" id="form" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-2">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="quantity" value="1" name="quantity" required>
                                    </div>
                                </div>
                                <div class="form-group col-2">
                                    <label class="form-label" for="price_hourly">Hourly Price</label>
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="price_hourly" value="0" name="price_hourly" required>
                                    </div>
                                </div>
                                <div class="form-group col-4">
                                    <label class="form-label" for="price_daily">Daily Price</label>
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="price_daily" value="0" name="price_daily" required>
                                    </div>
                                </div>
                                <div class="form-group col-2">
