                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">All {{ $media_category->name }}
                                        <a href="{{route('movie.create', $media_category->id)}}" class="btn btn-outline-success float-right"><em class="icon ni ni-plus"></em><span>Add {{ $media_category->name }} </span></a>
                                ...
                                <div class="card-inner">
                                    <table style="width: 100%;" class="datatable-init-export nk-tb-list nk-tb-ulist" data-export-title="Export" data-auto-responsive="false">
                                        ...
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col"><span class="sub-text">Movie Thumbnail</span></th>
                                            <th class="nk-tb-col"><span class="sub-text">Movie Access</span></th>
                                        ...
                                        @foreach ($movies as $movie)
                                            <tr class="nk-tb-item">
                                                <td class="nk-tb-col">
                                                    <a href="{{route('watch_movie', $movie->id)}}"><span>{{$movie->title}}</span></a>
                                                </td>
                                                <td class="nk-tb-col">
                                                    <img src="{{$movie->getFirstMediaUrl('thumbnail')}}" width="200px" alt="">
                                                </td>
                                                <td class="nk-tb-col">
                                                    <span>{{$movie->access}}</span>
                                                </td>
                                                <td class="nk-tb-col">
                                                    ...
                                                    <ul class="nk-tb-actions gx-1">
                                                        @can('edit_movie')
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{route('movie.edit', $movie->id)}}" class="btn btn-sm btn-outline-success d-inline-flex"><em class="icon ni ni-expand"></em><span>Edit</span></a>
                                                            </li>
                                                        @endcan
                                                        @can('delete_movie')
                                                            <li class="nk-tb-action-hidden">
