                ...
                <div class="nk-block-head nk-block-head-lg">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h4 class="nk-block-title">User Affiliation</h4>
                            <h4 class="nk-block-title">Referral Link: <u> {{url('/').'/register?ref='.$user->id}} </u></h4>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($referals as $referal)
                                            <tr>
                                                ...
                                                <td>{{ $referal->email }}</td>
                                                @php
                                                    $subscription = get_subscription_info($referal); 
                                                @endphp
                                                <td>
                                                    @if($subscription)
                ...
                <div class="card-inner-group" data-simplebar>
                    ...
                    <div class="card-inner p-0">
                        <ul class="link-list-menu">
                            ...
                            <li><a class="active" href="{{ route('user.affiliation.admin', $user->id) }}"><em class="icon ni ni-user-fill-c"></em><span>Affiliation</span></a></li>
                            @if($user->agreement)
