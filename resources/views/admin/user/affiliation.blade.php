                    ...
                    <div class="nk-block-head nk-block-head-lg">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                ...
                                <h4 class="nk-block-title">Referral Link: <u> {{url('/').'/register?ref='.\Illuminate\Support\Facades\Auth::id()}} </u></h4>
                            </div>
                        ...
                        <div class="card-inner p-0">
                            <ul class="link-list-menu">
                                ...
                                @else
                                    ...
                                    <li><a class="active" href="{{ route('user.affiliation') }}"><em class="icon ni ni-user-fill-c"></em><span>Affiliation</span></a></li>
