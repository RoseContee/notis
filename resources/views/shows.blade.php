        ...
        <div class="py-7">
            <div class="container flq-isotope">
                ...
                <div class="row gy-4 justify-content-center flq-isotope-grid" data-isotope-layout="fitRows" data-sr="movies-item" data-sr-interval="80" data-sr-duration="1000" data-sr-distance="10">
                    ...
                    @foreach($shows as $show)
                        @php
                            $show_genres = $show->genres->pluck('name')->toArray();
                        @endphp
                        <div class="col-12 col-lg-6 col-xl-4 flq-isotope-item {{ implode(' ', array_map(function ($genre) { return $genre; }, $show_genres)) }}">
                            <div data-sr-item="movies-item">
                                <a href="{{route('show', $show->id)}}" class="card flq-card-movie flq-color-opacity">
                        <span class="card-img-wrap">
                            ...
                            <span class="card-title h5">{{$show->title}}</span>
