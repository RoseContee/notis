...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.rolepermission.permissions.list',compact('rows'));
    }
   ...
   /**
    ...
    {
        return view('admin.rolepermission.permissions.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.rolepermission.permissions.edit',compact('row'));
    }
